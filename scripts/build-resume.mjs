...
template = template.replace('<html lang="zh-Hant"', '<html lang="{{LANG}}"')
  ...
  .replace('src="web-bridge.js?v=1.3.1"', 'src="resume-bridge.js?v=1"')
  .replaceAll('src="assets/app-icon-192.webp"', 'src="assets/lumareader.webp"')
  .replace('</head>', '  <link rel="stylesheet" href="resume.css?v=1" />\n</head>')
  ...
  .replace('<script src="resume-bridge.js?v=1"></script>', '<script src="resume-bridge.js?v=1"></script>\n  <script src="resume-print.js?v=1"></script>')
...
const inertIds = ['edit-document','cancel-edit','editor-preview-control','editor-insert-control','new-markdown-dialog','discard-edit-dialog','session-dialog','drop-overlay','onboarding'];
